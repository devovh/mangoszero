...
struct boss_lady_blaumeux : public CreatureScript
{
...
struct boss_alexandros_mograine : public CreatureScript
{
...
struct boss_thane_korthazz : public CreatureScript
{
...
struct boss_sir_zeliek : public CreatureScript
{
...
{
    Script* s;
    s = new boss_lady_blaumeux();
    s->RegisterSelf();
    s = new boss_alexandros_mograine();
    s->RegisterSelf();
    s = new boss_thane_korthazz();
    s->RegisterSelf();
