...
struct go_mausoleum_door : public GameObjectScript
{
...
struct go_mausoleum_trigger : public GameObjectScript
{
...
struct npc_calvin_montague : public CreatureScript
{
