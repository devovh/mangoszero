...
struct boss_jeklik : public CreatureScript
{
...
struct npc_gurubashi_bat_rider : public CreatureScript
{
    npc_gurubashi_bat_rider() : CreatureScript("npc_gurubashi_bat_rider") {}
