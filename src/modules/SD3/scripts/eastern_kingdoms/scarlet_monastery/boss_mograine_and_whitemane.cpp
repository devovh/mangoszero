...
struct boss_scarlet_commander_mograine : public CreatureScript
{
...
struct boss_high_inquisitor_whitemane : public CreatureScript
{
...
{
    Script *s;
    s = new boss_scarlet_commander_mograine();
    s->RegisterSelf();
    s = new boss_high_inquisitor_whitemane();
    s->RegisterSelf();
}
